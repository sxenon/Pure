...
public abstract class BaseNoHttpListResultDispatcher<T> extends BaseNoHttpResultDispatcher<T> {
    public BaseNoHttpListResultDispatcher(IResultHandler resultHandler) {
        super(resultHandler);
    }
