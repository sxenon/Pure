 ...
 */
@Deprecated
public abstract class VerificationCodeGroup<T,R> implements ISubmitResultHandler<R>,ISingleDataSubmitter<T> {
    private CountDownTimer mCountDownTimer;
    private final long mMillisInFuture;
    private final CountDownListener mCountDownListener;

    public VerificationCodeGroup(IRouter router,long millisInFuture,CountDownListener countDownListener){
