...
public class TwinkingRefreshAndMoreViewModule<R> extends BaseListViewModule<R, TwinklingPullLayout> {
    public TwinkingRefreshAndMoreViewModule(Context context, TwinklingRefreshLayout refreshLayout, IListStrategy<R> fillPageStrategy, int dataSizeForFullPage) {
