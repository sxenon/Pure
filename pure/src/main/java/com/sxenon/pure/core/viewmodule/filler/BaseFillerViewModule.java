...
/**
 * Base implement for IFillerViewModule
 * Created by Sui on 2017/8/4.
 */

public abstract class BaseFillerViewModule<PL extends IPullLayout,S extends IFillStrategy> implements IFillerViewModule {
    private final IFillStrategy.PageInfo pageInfo = new IFillStrategy.PageInfo(-1, -1);
     ...
     */
    public BaseFillerViewModule(Context context, PL pullLayout, S fillPageStrategy) {
        mPullLayout = pullLayout;
        mFillPageStrategy = fillPageStrategy;
        mContext = context;
    }

    public BaseFillerViewModule setExtraComponents(View emptyView, View exceptionView) {
    ...
    public BaseFillerViewModule setLoadingView(ILoadingView loadingView){
    ...
    public IFillStrategy.PageInfo getPageInfo() {
        return pageInfo;
    }
    //Setter end
}
