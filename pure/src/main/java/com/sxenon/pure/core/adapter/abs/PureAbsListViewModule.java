...
public abstract class PureAbsListViewModule<T> implements IAdapterViewModule<T> {
    private final int position;
    private final PureAbsListAdapter adapter;
    private final IViewModule adapterContainer;
    public final View itemView;

    public PureAbsListViewModule(View itemView, PureAbsListAdapter adapter, int position) {
