...
import com.sxenon.pure.core.viewmodule.filler.BaseFillerViewModule;
...
public class BaseSingleViewModule<R, PL extends IPullLayout> extends BaseFillerViewModule<PL,ISingleStrategy<R>> implements ISingleViewModule<R> {
