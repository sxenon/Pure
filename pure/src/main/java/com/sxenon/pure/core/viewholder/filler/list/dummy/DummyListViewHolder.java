...
public class DummyListViewHolder<R> extends BaseListViewHolder<R, DummyPullLayout> {
    ...
    public DummyListViewHolder(Context context, IAdapterStrategy<R> fillAdapterStrategy, int dataSizeInFullPage) {
