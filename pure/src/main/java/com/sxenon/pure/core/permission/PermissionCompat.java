...
public class PermissionCompat {
     ...
     */
    @Nullable
    public static String getFirstDeclinedPermission(@NonNull IController router, @NonNull String[] permissions) {
     ...
     */
    public static String[] getDeclinedPermissionArray(@NonNull IController router, @NonNull String[] permissions) {
        return (String[]) getDeclinedPermissionList(router, permissions).toArray();
    }

    public static List<String> getDeclinedPermissionList(@NonNull IController router, @NonNull String[] permissions) {
     ...
     */
    public static boolean isPermissionGranted(@NonNull IController router, @NonNull String permission) {
     ...
     * can be used outside of router.
     */
    public static boolean isPermissionDeclined(@NonNull IController router, @NonNull String permission) {
        return ContextCompat.checkSelfPermission(router.getContext(), permission) != PackageManager.PERMISSION_GRANTED;
    }
     ...
     */
    public static boolean isExplanationNeeded(@NonNull IController router, @NonNull String permissionName) {
     ...
     */
    public static boolean isPermissionPermanentlyDenied(@NonNull IController router, @NonNull String permission) {
        return isPermissionDeclined(router, permission) && !isExplanationNeeded(router, permission);
    }

    public static List<String> getPermissionPermanentlyDeniedList(@NonNull IController router, @NonNull String[] permissions) {
     ...
     */
    public static boolean isPermissionExisted(@NonNull IController router, @NonNull String permission) {
    ...
    public static boolean isSystemAlertGranted(@NonNull IController router) {
